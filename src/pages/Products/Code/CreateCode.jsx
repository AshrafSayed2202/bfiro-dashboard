...
const CreateCode = () => {
    ...
    const formatOptions = ['React', 'Next.js', 'Vue', 'Svelte', 'HTML/CSS/JS', 'Tailwind', 'Framer Motion', 'React Native'];
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            formData.append('type', 'Coded Templates'); // Fixed type
            ...
            alert('Code Template created successfully!');
            navigate('/code');
        } catch (error) {
            console.error('Error creating product:', error);
            alert('Failed to create Code Template. Please try again.');
        } finally {
            setSaving(false);
        }
    };
    ...
    return (
        <div>
            <Header title="Create New Code Template" />
            ...
            <div className="mt-8 bg-[#171718CC] p-8 rounded-[20px] max-w-5xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g. Dashboard Code Template"
                        />
                    </div>
                    <div>
                ...
                <div className="flex gap-4 justify-end">
                    ...
                    >
                        {saving ? 'Saving...' : 'Save Code Template'}
                    </button>
                </div>
            </div>
        </div >
