...
const EditIcons = () => {
    ...
    const mockData = [
        { id: 1, date: '2023-01-01', name: 'Icon 1', format: 'PSD', solds: 10, price: 99, status: 'active' },
        { id: 2, date: '2023-02-15', name: 'Icon 2', format: 'Figma', solds: 5, price: 149, status: 'inactive' },
        { id: 3, date: '2023-03-20', name: 'Icon 3', format: 'Sketch', solds: 20, price: 79, status: 'active' },
        { id: 4, date: '2023-04-10', name: 'Icon 4', format: 'XD', solds: 0, price: 199, status: 'active' },
        { id: 5, date: '2023-05-05', name: 'Icon 5', format: 'PSD', solds: 15, price: 89, status: 'inactive' },
        { id: 6, date: '2023-06-18', name: 'Icon 6', format: 'Figma', solds: 8, price: 129, status: 'active' },
        { id: 7, date: '2023-07-22', name: 'Icon 7', format: 'Sketch', solds: 3, price: 99, status: 'active' },
        { id: 8, date: '2023-08-30', name: 'Icon 8', format: 'XD', solds: 12, price: 159, status: 'inactive' },
        { id: 9, date: '2023-09-14', name: 'Icon 9', format: 'PSD', solds: 7, price: 109, status: 'active' },
        { id: 10, date: '2023-10-25', name: 'Icon 10', format: 'Figma', solds: 25, price: 69, status: 'active' },
    ];
    ...
    useEffect(() => {
        ...
        setTitle(found.name);
        setSubtitle('Premium Dashboard & WebApp Icon');
        ...
        setTags(['icons', 'dashboard', 'admin', 'template', 'figma', 'responsive']);
        setDate(found.date);
