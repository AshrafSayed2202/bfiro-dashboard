...
// src/pages/ui-kits/EditUIKits.jsx   (View + Edit page - route: /ui-kits/edit/:id)
...
const EditUIKits = () => {
    ...
    useEffect(() => {
        ...
        setTitle(found.name);
        setSubtitle('Premium Dashboard & WebApp UI Kit');
        ...
        setTags(['uikit', 'dashboard', 'admin', 'template', 'figma', 'responsive']);
        setDate(found.date);
