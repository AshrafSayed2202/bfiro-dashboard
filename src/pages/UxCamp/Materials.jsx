...
const Materials = () => {
    ...
    const fetchMaterials = async () => {
        try {
            setLoading(true);
            const response = await axios.get('http://localhost/bfiro_backend/fetch/admin/uxCamp/matrials.php');
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await axios.post('http://localhost/bfiro_backend/actions/admin/uxCamp/editMaterial.php', form, {
    ...
    const colDefs = [
        ...
        { field: 'type', headerName: 'Type', flex: 1 },
        {
            ...
            cellRenderer: (params) => params.value ? (
                <a href={baseUrl + params.value} download className="text-blue-500 hover:underline">Download</a>
            ) : 'No file'
        },
            ...
            {showModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-[#171718CC] p-8 rounded-[20px] w-96">
                        <h2 className="text-white text-2xl mb-4">{isEdit ? 'Edit' : 'Add'} Material</h2>
