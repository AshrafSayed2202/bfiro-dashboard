...
const Status = () => {
  ...
  const fetchCamps = async () => {
    try {
      ...
      const totalStudents = transformedData.reduce(
        (sum, d) => sum + d.enrolled_count,
        0
      );
      const totalIncome = transformedData.reduce(
        (sum, d) => sum + d.total_income,
        0
      );
