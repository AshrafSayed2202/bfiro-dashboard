...
const YearlyAccess = () => {
    ...
    const fetchYearlyAccess = async () => {
        try {
            setLoading(true);
            const response = await axios.get('http://localhost/bfiro_backend/fetch/admin/accessYearly/getAccessYearly.php');
            ...
            const unauthorized = transformedData.reduce((sum, d) => sum + d.unauthorized, 0);
    ...
    const handleAddUser = async () => {
        try {
            const response = await axios.post('http://localhost/bfiro_backend/actions/accessYearly/addUser.php', formData);
    ...
    const handleToggleStatus = async (userId, currentStatus) => {
        ...
        try {
            const response = await axios.post('http://localhost/bfiro_backend/fetch/accessYearly/editUser.php', {
                user_id: userId,
                status: newStatus
            });
        ...
        },
        {
            ...
            cellRenderer: (params) => (
                <button
                    ...
                    onClick={() => handleToggleStatus(params.data.userId, params.data.status)}
                >
        ...
        <div>
            ...
            <div className="mt-6 flex flex-wrap gap-6">
                ...
                <div className="bg-[#171718CC] p-5 rounded-[20px] flex-1 min-w-[200px] text-center">
                    ...
                    <p className="text-4xl font-bold text-white mt-2">{stats.unauthorized}</p>
                </div>
            </div>
