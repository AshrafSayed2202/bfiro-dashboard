...
const Contacts = () => {
    ...
    const fetchContacts = async () => {
        try {
            setLoading(true);
            const response = await axios.get('http://localhost/bfiro_backend/fetch/admin/contact/getContacts.php');
    ...
    const handleSave = async () => {
        try {
            const response = await axios.post('http://localhost/bfiro_backend/actions/admin/contact/edit.php', {
                figma,
                behance,
                dribble,
                instagram,
