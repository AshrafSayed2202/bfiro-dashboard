...
const Aside = () => {
  ...
  const isUiKitsActive = currentPath.includes("/ui-kits");
  const isCodeActive = currentPath.includes("/code");
  const isIconsActive = currentPath.includes("/icons");
  const isIllustrationsActive = currentPath.includes("/illustrations");
  ...
  return (
    ...
    >
      <button
        ...
        className={`text-xl absolute top-4 left-full bg-[#171718CC] p-1 rounded-r-full border border-[#424242] z-10 ${
        ...
        <ul className={`${isCollapsed ? "" : "px-4"}`}>
          <li>
            <Link
              ...
              } ${isDashboardActive ? "!bg-[#1D2030] text-[#1FCCFF]" : ""}`}
            >
          ...
          <li>
            <button
              ...
              className={`flex trans-3 items-center p-4 w-full text-left hover:bg-[#333] ${
                isCollapsed ? "" : "rounded-[10px]"
              } ${isProductsButtonActive ? "text-white" : ""}`}
            >
              <div className="size-[24px] min-w-[24px] rounded-full flex items-center justify-center mr-2">
            ...
            <motion.ul
              ...
              className={`overflow-hidden border-[#424242] ${
                isCollapsed ? "border-l-[3px]" : "border-l-[1px]"
              }`}
            >
              <li>
                <Link
                  to="/ui-kits"
                  className={`flex trans-3 items-center ${
                    isCollapsed ? "!p-4" : "pl-8 rounded-r-[10px]"
                  } p-2 hover:bg-[#333] ${
                    isUiKitsActive ? "!bg-[#1D2030] text-[#1FCCFF]" : ""
                  }`}
                >
              ...
              <li>
                <Link
                  ...
                  className={`flex trans-3 items-center ${
                    ...
                    isCodeActive ? "!bg-[#1D2030] text-[#1FCCFF]" : ""
                  }`}
                >
                  <div className="size-[24px] min-w-[24px] rounded-full flex items-center justify-center bg-[#5B5E79] mr-2">
              ...
              <li>
                <Link
                  ...
                  className={`flex trans-3 items-center ${
                    ...
                    isIconsActive ? "!bg-[#1D2030] text-[#1FCCFF]" : ""
                  }`}
                >
                  <div className="size-[24px] min-w-[24px] rounded-full flex items-center justify-center bg-[#5B5E79] mr-2">
              ...
              <li>
                <Link
                  ...
                  className={`flex trans-3 items-center ${
                    ...
                    isIllustrationsActive ? "!bg-[#1D2030] text-[#1FCCFF]" : ""
                  }`}
                >
                  <div className="size-[24px] min-w-[24px] rounded-full flex items-center justify-center bg-[#5B5E79] mr-2">
              ...
              <li>
                <Link
                  ...
                  className={`flex trans-3 items-center ${
                    ...
                    isFontsActive ? "!bg-[#1D2030] text-[#1FCCFF]" : ""
                  }`}
                >
                  <div className="size-[24px] min-w-[24px] rounded-full flex items-center justify-center bg-[#5B5E79] mr-2">
          ...
          <li>
            <Link
              ...
              className={`flex trans-3 items-center p-4 hover:bg-[#333] ${
                isCollapsed ? "" : "rounded-[10px]"
              } ${isPricingActive ? "!bg-[#1D2030] text-[#1FCCFF]" : ""}`}
            >
              <div className="size-[24px] min-w-[24px] rounded-full flex items-center justify-center mr-2">
          ...
          <li>
            <button
              ...
              className={`flex trans-3 items-center p-4 w-full text-left hover:bg-[#333] ${
                isCollapsed ? "" : "rounded-[10px]"
              } ${isUxCampButtonActive ? "text-white" : ""}`}
            >
              <div className="size-[24px] min-w-[24px] rounded-full flex items-center justify-center mr-2">
              ...
              <li>
                <Link
                  ...
                  className={`flex trans-3 items-center ${
                    ...
                    isStatusActive ? "!bg-[#1D2030] text-[#1FCCFF]" : ""
                  }`}
                >
                  <div className="size-[24px] min-w-[24px] rounded-full flex items-center justify-center mr-2">
              ...
              <li>
                <Link
                  ...
                  className={`flex trans-3 items-center ${
                    ...
                    isMaterialsActive ? "!bg-[#1D2030] text-[#1FCCFF]" : ""
                  }`}
                >
                  <div className="size-[24px] min-w-[24px] rounded-full flex items-center justify-center mr-2">
          ...
          <li>
            <Link
              ...
              className={`flex trans-3 items-center p-4 hover:bg-[#333] ${
                isCollapsed ? "" : "rounded-[10px]"
              } ${isYearlyActive ? "!bg-[#1D2030] text-[#1FCCFF]" : ""}`}
            >
              <div className="size-[24px] min-w-[24px] rounded-full flex items-center justify-center mr-2">
          ...
          <li>
            <Link
              ...
              className={`flex trans-3 items-center p-4 hover:bg-[#333] ${
                isCollapsed ? "" : "rounded-[10px]"
              } ${isTeamActive ? "!bg-[#1D2030] text-[#1FCCFF]" : ""}`}
            >
              <div className="size-[24px] min-w-[24px] rounded-full flex items-center justify-center mr-2">
          ...
          <li>
            <Link
              ...
              className={`flex trans-3 items-center p-4 hover:bg-[#333] ${
                isCollapsed ? "" : "rounded-[10px]"
              } ${isUsersActive ? "!bg-[#1D2030] text-[#1FCCFF]" : ""}`}
            >
              <div className="size-[24px] min-w-[24px] rounded-full flex items-center justify-center mr-2">
          ...
          <li>
            <Link
              ...
              className={`flex trans-3 items-center p-4 hover:bg-[#333] ${
                isCollapsed ? "" : "rounded-[10px]"
              } ${isContactActive ? "!bg-[#1D2030] text-[#1FCCFF]" : ""}`}
            >
              <div className="size-[24px] min-w-[24px] rounded-full flex items-center justify-center mr-2">
          ...
          <li>
            <button
              ...
              className={`flex trans-3 items-center p-4 w-full text-left hover:bg-[#333] ${
                isCollapsed ? "" : "rounded-[10px]"
              } ${isLogoutActive ? "!bg-[#1D2030] text-[#1FCCFF]" : ""}`}
            >
              <div className="size-[24px] min-w-[24px] rounded-full flex items-center justify-center mr-2">
      ...
      <div className="p-4 border-t border-[#424242]">
        <div className="flex items-center">
          <img
            src={user?.image || "https://placeholder.co/40"}
            alt="User"
